...
The demo supports Gemini models compatible with Live API:
...
-  Gemini API : Check the official Gemini models documentation
...
### Model Errors
 ...
 Solutions :
- Verify model name matches Gemini
...
-  Gemini API : https://ai.google.dev/api/multimodal-live
